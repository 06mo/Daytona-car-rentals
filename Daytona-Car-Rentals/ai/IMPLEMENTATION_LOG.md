...
| DCR-064 | Implement insurance domain types + Firestore schema | Codex | ⏳ Proposed | `types/insurance.ts`, Firestore schema/rules/index updates |
...
| DCR-066 | Add booking status split (payment authorized vs insurance cleared) | Codex | ⏳ Proposed | Booking flow + Stripe webhook updates |
...
| DCR-068 | Implement coverage decision engine | Codex | ⏳ Proposed | `lib/insurance/evaluateCoverage.ts`, `lib/services/coverageDecisionService.ts` |
